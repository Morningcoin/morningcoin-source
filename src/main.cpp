...
#if defined(NDEBUG)
# error "morningcoin cannot be compiled without assertions."
#endif
...
int nStakeMinConfirmations = 2880;
unsigned int nStakeMinAge = 2 * 24 * 60 * 60; //
...
const string strMessageMagic = "morningcoin Signed Message:\n";
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * (5 / 2);
    }
    else
    {
...
{
    RenameThread("morningcoin-loadblk");
